    ...
    return <footer className={className + " " + "flex flex-col bg-gray-50 lg:bg-white"}>
        <div className={"flex flex-row mb-4"}>
            <a href={"https://www.linkedin.com/in/tamir-shklaz/"} target={"_blank"}>
                <IoLogoLinkedin
                    className={"text-gray-400 text-3xl mr-2 hover:cursor-pointer"}/>
            </a>
            ...
            <a href={"https://github.com/TamirShklaz"} target={"_blank"}>
                <IoLogoGithub
                    className={"text-gray-400 text-3xl hover:cursor-pointer mr-2"}/>
            </a>
            <a href={"mailto:shklazt@gmail.com"} target={"_blank"}>
                <IoMailOutline className={"text-gray-400 text-3xl hover:cursor-pointer"}/>
